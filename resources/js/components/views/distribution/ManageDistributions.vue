    ...
    <main class="flex-1 flex justify-center p-10">
      <div class="w-full max-w-7xl bg-white rounded-3xl shadow-2xl p-10 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-4 mb-8">
          ...
          <!-- Right: Create Distribution Button -->
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="dist in filteredDistributions" :key="dist.id" class="bg-[#f9fbfd] p-8 rounded-2xl border border-[#e3e3e3] shadow relative">
