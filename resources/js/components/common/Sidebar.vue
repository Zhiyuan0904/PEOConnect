<template>
  <aside class="w-1/5 bg-[#f4f4f4] text-[#1B3A57] p-5 flex flex-col font-sans shadow-md">
    <!-- Logo -->
    ...
    <!-- Navigation -->
    <nav class="flex-grow space-y-2 text-[16px]">
      <!-- Dashboard -->
    ...
    <!-- Logout -->
    <button @click="handleLogout" class="flex items-center gap-2 text-[#4072bc] hover:text-[#f07ba3] transition font-medium mt-10">
...
import SidebarLink from './SidebarLink.vue'; // We'll create reusable SidebarLink component
